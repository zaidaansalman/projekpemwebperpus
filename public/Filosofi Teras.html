    ...
    <main>
      ...
      <section class="book-info" aria-label="Book information">
        ...
        <nav class="breadcrumb" aria-label="Breadcrumb">
          <a href="index.html" tabindex="0">Home</a> / <a href="/sci-fi-fantasy" tabindex="0">Fiksi Psikologis</a> /
        </nav>
        ...
        <div style="display:flex;gap:1.5rem;align-items:flex-start;">
          ...
          <div>
            <p><strong>Penulis:</strong> <a href="#" tabindex="0">Henry Manampiring</a></p>
            <p><strong>Penerbit:</strong> <span>Buku Kompas</span></p>
            <p><strong>Pages:</strong> <span>350</span></p>
      ...
      <p>
        Filosofi Teras adalah buku karya Henry Manampiring yang mengupas ajaran Stoisisme, sebuah aliran filsafat Yunani kuno, dengan pendekatan yang relevan dan mudah dipahami untuk kehidupan modern. Buku ini menjelaskan bagaimana prinsip-prinsip Stoisisme dapat membantu kita mengatasi stres, kecemasan, dan tantangan sehari-hari dengan lebih tenang dan bijaksana.
        </p>
          </div>
        </div>
      </section>
